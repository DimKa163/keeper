...
const (
	Users_Login_FullMethodName    = "/go.Users/Login"
	Users_Register_FullMethodName = "/go.Users/Register"
)

// UsersClient is the client API for Users service.
//
// For semantics around auth use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
...
func (c *usersClient) Login(ctx context.Context, in *User, opts ...grpc.CallOption) (*UserResponse, error) {
...
func (c *usersClient) Register(ctx context.Context, in *User, opts ...grpc.CallOption) (*UserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserResponse)
...
func (UnimplementedUsersServer) Login(context.Context, *User) (*UserResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Login not implemented")
}
func (UnimplementedUsersServer) Register(context.Context, *User) (*UserResponse, error) {
...
var Users_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "app/api/proto/user.proto",
}
